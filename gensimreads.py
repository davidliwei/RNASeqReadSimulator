...
HISTORY
	...
	02/08/2012 Change default value of NFIELD from 4 to 7 to be compatible with default genexplvprofile values.

	01/29/2012 Add paired-end support.

	01/09/2012 Add -f option.
...
for lines in open(bedfile):
  ...
  if len(posweight)!=0:
    ...
    for i in range(selrange):
      ...
      nlower=math.floor(nfrac); # 0-100
      nhigher=math.ceil(nfrac); # 0-100
